...
2. 	Create Data Model
Tool: Power Query
Purpose: Clean, transform, and structure the data for reporting.
3. 	Build Income Statement
Tool: Power BI
Purpose: Visualize revenue, expenses, and net income using dynamic dashboards.
4. 	Build Balance Sheet
Tool: Power BI
Purpose: Present assets, liabilities, and equity in an interactive format.
5. 	Analyze in Excel
Tool: Microsoft Excel
Purpose: Perform ad hoc analysis, scenario modeling, and export reports for stakeholders.
